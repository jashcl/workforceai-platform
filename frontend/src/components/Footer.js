  ...
  return (
    ...
    >
      ...
      <Container maxWidth="lg">
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography variant="body2">
              We provide a comprehensive workforceai-platform that helps you manage your employees and departments with ease. Our mission is to make HR
        ...
        >
          <Typography variant="body2">© {new Date().getFullYear()} workforceai-platform. All rights reserved.</Typography>
        </Box>
      </Container>
    </Box>
  );
