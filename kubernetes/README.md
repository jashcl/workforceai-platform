...
The `kubernetes/` directory contains production-ready manifests for deploying the workforceai-platform to Kubernetes with support for multiple deployment strategies including blue-green and canary deployments.
