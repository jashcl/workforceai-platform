# workforceai-platform - Backend

## Overview

The backend of the workforceai-platform is built using Spring Boot, a powerful Java framework designed to simplify the development of production-ready applications. This backend provides a RESTful API for managing employee and department data, connecting to both MySQL and MongoDB databases.
...
```bash
git clone https://github.com/jashcl/workforceai-platform.git
